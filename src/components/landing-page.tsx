    ...
    <div className="relative flex flex-col min-h-screen  text-white">
      ...
      <header className="px-4 lg:px-6 h-20 flex items-center">
        ...
        <nav className="ml-auto flex gap-6 items-center">
          ...
          <a className="text-sm font-medium text-gray-300 hover:text-white transition-colors" href="#audience">
            Audience
          </a>
          <a className="text-sm font-medium text-gray-300 hover:text-white transition-colors" href="#criteria">
            Criteria
          </a>
          <a className="text-sm font-medium text-gray-300 hover:text-white transition-colors" href="#timeline">
            Timeline
          </a>
          <a className="text-sm font-medium text-gray-300 hover:text-white transition-colors" href="#overview">
            Overview
          </a>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-400">Angel investors, family offices, VC firms, or syndicates</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="mr-2 h-6 w-6 text-green-500 flex-shrink-0" />
                    <span className="text-gray-400">Investors seeking investment in current cycle ($50-250k avg. check size per investor)</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <Check className="mr-2 h-6 w-6 text-green-500 flex-shrink-0" />
                    <span className="text-gray-400">Startup actively raising $1.5M+ seed round</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="mr-2 h-6 w-6 text-green-500 flex-shrink-0" />
                    <span className="text-gray-400">$250k+ ARR</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="mr-2 h-6 w-6 text-green-500 flex-shrink-0" />
                    <span className="text-gray-400">Industry agnostic</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="mr-2 h-6 w-6 text-green-500 flex-shrink-0" />
                    <span className="text-gray-400">US registered company</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <footer className="border-t border-gray-800 py-12">
        <div className="px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">© 2023 Miami50. All rights reserved.</p>
